        ...
        <div className="px-2 py-3 md:px-20 md:py-5 mx-auto  flex justify-between items-center shadow-md md:shadow-lg z-10 ">
          ...
          <ul
            className={` md:flex md:static absolute left-0 z-10  md:gap-5 w-full md:w-auto  ${
              isClicked
                ? "translate-y-24  duration-700  bg-slate-300 md:bg-transparent pt-2 pb-5 px-5 "
          ...
          <div className="flex items-center gap-2">
            {user && (
              <img
                ...
                className="w-10 h-10 rounded-full border-green-300 border-2 shadow-md"
                src={user.photoURL}
                alt=""
              />
            )}
            {user ? (
              <button
                ...
                className="px-3 bg-slate-700 hover:bg-slate-800 text-white py-2 rounded-md shadow-md"
              >
                Logout
              </button>
            ) : (
              <Link to="/login">
                <button className="px-3 bg-slate-700 hover:bg-slate-800 text-white py-2 rounded-md shadow-md">
                  Login
                </button>
              </Link>
            )}
