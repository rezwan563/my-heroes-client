        ...
        const swalWithBootstrapButtons = Swal.mixin({
          ...
          swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
              swalWithBootstrapButtons.fire(
                'Deleted!',
                'Your toy details has been deleted.',
                'success'
              )
            } else if (
    ...
    <div>
      <div className="mt-12 mx-2 md:mx-36">
        <div className="mb-2 text-end">
          <p className="text-2xl">{myToys.length}</p>
        ...
        <table className="border-collapse border-slate-400 mx-2 md:w-full">
          ...
          <tbody>
           ...
           {
            myToys.length > 1 &&  <MyToysRow myToys={myToys} handleDelete={handleDelete}  hadnleEdit={hadnleEdit}></MyToysRow>
           }
